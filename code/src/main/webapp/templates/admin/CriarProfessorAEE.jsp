...
<head>
    ...
    <title>Gestão de Professores AEE</title>
    <style>
        * {
            margin: 0;
            padding: 0;
...
<body>
    ...
    <div class="sidebar">
        ...
        <div class="menu">
            ...
            <button class="menu-btn ativo"
                ...
                <img src="${pageContext.request.contextPath}/static/images/sidebar/professores.svg" alt="Professores AEE" />
                Professores AEE
            </button>
            <button class="menu-btn"
    ...
    <div class="conteudo-principal">
        <div class="header">
            <div class="titulo">
                <h1>Gestão de Professores AEE</h1>
            </div>
            <div class="user-info">
        ...
        <div class="conteudo-container">
            ...
            <div class="modal-overlay" id="modalNovoProfessorAEE">
                <div class="modal-conteudo">
                    <h3>Cadastrar Novo Professor AEE</h3>
                    <form id="formNovoProfessorAEE" action="${pageContext.request.contextPath}/templates/aee/professoresAEE?acao=criar" method="POST">
                                    ...
                                    <td>
                                        <div class="botoes-acoes">
                                            <button class="botao-editar"
                                                onclick="abrirEdicao('${professorAEE.siape}')">Editar</button>
                                            <button class="botao-excluir"
                                                onclick="confirmarExclusao('${professorAEE.siape}')">Excluir</button>
            ...
            <div class="modal-overlay" id="modalEditar">
                <div class="modal-conteudo">
                    <h3>Editar Professor AEE</h3>
                    <form id="formEditarProfessor" action="${pageContext.request.contextPath}/templates/aee/professoresAEE?acao=atualizar" method="POST">
            ...
            <div class="modal-overlay" id="modalExcluir">
                <div class="modal-conteudo">
                    ...
                    <p>Tem certeza que deseja excluir este professor AEE? Esta ação não pode ser desfeita.</p>
                    <form id="formExcluirProfessor" action="${pageContext.request.contextPath}/templates/aee/professoresAEE?acao=excluir" method="POST">
    ...
    <script>
        ...
        function abrirEdicao(siape) {
            // Buscar dados do professor AEE (em uma implementação real, faríamos uma requisição AJAX)
            ...
            document.getElementById('editSiape').value = professor.siape;
            document.getElementById('editNome').value = professor.nome;
            document.getElementById('editDataNascimento').value = professor.dataNascimento;
            document.getElementById('editEmail').value = professor.email;
            document.getElementById('editSexo').value = professor.sexo;
            document.getElementById('editNaturalidade').value = professor.naturalidade;
            document.getElementById('editTelefone').value = professor.telefone;
            document.getElementById('editEspecialidade').value = professor.especialidade;
