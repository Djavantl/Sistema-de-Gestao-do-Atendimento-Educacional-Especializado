                                ...
                                <tr class="linha-principal" data-id="${professor.siape}">
                                    ...
                                    <td>
                                        <div class="container-acoes">
                                            <button class="botao-acao botao-editar" onclick="abrirEdicao('${professor.siape}')">
        ...
        <div class="modal-overlay" id="modalEditar">
            <div class="modal-conteudo">
                ...
                <form id="formEditarProfessor"
                      action="${pageContext.request.contextPath}/templates/aee/professores?acao=atualizar"
                      method="POST">
                    <input type="hidden" name="siape" id="siapeEditar">
                    ...
                    <label for="naturalidadeEditar">Naturalidade:</label>
                    <input type="text" id="naturalidadeEditar" name="naturalidade">

                    <label for="telefoneEditar">Telefone:</label>
                    <input type="tel" id="telefoneEditar" name="telefone">

                    <label for="especialidadeEditar">Especialidade:</label>
                    <input type="text" id="especialidadeEditar" name="especialidade" required>
